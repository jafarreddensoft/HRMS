...
class CompanyDetailsController extends Controller
{
    public function signup(Request $req){
        $prev_reg_details = CompanyDetails::where('email',$req->email)->first();
        ...
        if ($prev_reg_details) {
            ...
            $registration = new CompanyDetails;
    ...
    public function verifymail(Request $req){
        $prev_reg_details = CompanyDetails::where(['verifcationtoken'=>$req->token,'verificationstatus'=>'no'])->first();
        // dd('test');
        if ($prev_reg_details) {
            $updateverificationstatus = CompanyDetails::where(['verifcationtoken'=>$req->token,'verificationstatus'=>'no'])->update([
