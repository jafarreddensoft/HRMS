                        ...
                        <TabPanels class="col-span-5 pl-7">
                            ...
                            >
                                ...
                                <div> 
                                    ...
                                    <DepartmentSetting  @callback="HandleCallback" @callbackProceed="HandelcallbackProceed" v-else-if="stepsDetails.stepCount === 3"/>
                                    <DesignationsSetting @callback="HandleCallback" @callbackProceed="HandelcallbackProceed" v-else-if="stepsDetails.stepCount === 4" />
                                    <LeaveSettings @callback="HandleCallback" @callbackProceed="HandelcallbackProceed" v-else-if="stepsDetails.stepCount === 5"/>
                                </div>
