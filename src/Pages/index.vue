        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-20">
          ...
          <div class="text-center">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <router-link to="/sign-up" class="transition-all rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-blue-500 shadow-sm hover:bg-blue-500 hover:text-white focus-visible:outline ">Get started</router-link>
              <router-link to="/login" class="transition-all rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline ">Log In<span aria-hidden="true">→</span></router-link>
            </div>
          </div>
        </div>
